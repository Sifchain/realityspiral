...
export const DEFAULT_CHARACTER = "chronis";
...
async function runIntegrationTest(fn) {
	log(fn);
	const skip = Object.prototype.hasOwnProperty.call(fn, "skipIf")
		? fn.skipIf
		: false;
	if (skip) {
		log(
		...
		log(
			fn.description ? `Running test ${fn.description}...` : "Running test...",
		);
