import { USDC_MAINNET, USDT_MAINNET, VIRTUAL_BASE } from "../../../build/main";
import { SimulationStatus } from "../../../src/providers/simulation-provider";
import { breakDownTenderlySimulationError } from "../../../src/util/tenderlySimulationErrorBreakDown";

describe("tenderly simulation error break down", () => {
	it("V3TooMuchRequested", async () => {
		const simulationStatus = breakDownTenderlySimulationError(
			USDC_MAINNET,
			USDT_MAINNET,
			"0x739dbe52",
		);
