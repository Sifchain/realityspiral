 ...
 */
router.get("/:characterName", getTemplates);
 ...
 *         description: Character not found.
 */
router.post("/:characterName", addTemplate);
 ...
 */
router.put("/:characterName", updateTemplate);
 ...
 *         description: Template or character not found.
 */
router.delete("/:characterName/:templateName", deleteTemplate);
 ...
 *         description: Character not found.
 */
router.put("/:characterName/batch-update", batchUpdateCharacterData);
