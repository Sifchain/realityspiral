...
// stROSE contract ABI for redeeming
const STROSE_ABI = [
    {
        name: "redeem",
        inputs: [
...
const REDEEM_SHARES = "5"; // Amount of shares to redeem

async function redeemRose() {
    try {
        ...
        console.log("Preparing to redeem ROSE...");
        console.log({
        ...
        const tx = await contract.redeem(
            ethers.parseEther(REDEEM_SHARES),
            RECEIVER_ADDRESS,
            OWNER_ADDRESS,
            {
        ...
        console.error("Error redeeming ROSE:", error);
